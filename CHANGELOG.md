...
- Add `autoGesture` to `<Go>`, and ship the driver behind it as `@lynx-js/go-web/auto-gesture`. ([#80](https://github.com/lynx-community/go-web/pull/80))
